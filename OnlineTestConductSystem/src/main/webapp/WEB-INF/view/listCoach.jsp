					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> Coach <span
									...
									<ul class="nav child_menu">
										<li><a href="<spring:url value="/employee/addCoach" />">Add
												Coach</a></li>
							...
							<li><a><i class="fa fa-home"></i> Student <span
									class="fa fa-chevron-down"></span></a>
								<ul class="nav child_menu">
									<li><a href="<spring:url value="/employee/addStudent" />">Add
											Studnet</a></li>
									<li><a href="<spring:url value="/employee/listStudent" />">List
											Of Student</a></li></li>
							</ul>
							</li>
							</ul>
						...
						<div class="col-sm-10">
							<table id="c_table" class="table table-hover">
								...
								<tbody>
									...
									<c:forEach items="${listOfCoach}" var="coach">

										<tr>
											<td id="hehe">${coach.name}</td>
											<td>${coach.email}</td>
											<td>${coach.username}</td>
											<td>${coach.password}</td>
											<td><a
												href="<spring:url value="/coach/edit/${coach.id}" />">Edit</a></td>
													...
													<div class="modal-dialog">
														...
														<div class="modal-content">
															...
															<div class="modal-footer">
																<a href="<spring:url value="/coach/delete/${coach.id}" />"
