							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> Home <span
									...
									<ul class="nav child_menu">
										<li><a href="<c:url value = '/employee'></c:url>">Home
												Page </a></li>
										<li><a
											href="<c:url value = '/employee/studentList'></c:url>">List
												of Student</a></li>
									</ul></li>
							</ul>
						</div>
					...
					<tbody>
						...
						<c:forEach items="${listOfUsers}" var="usr">
							...
							<tr>
								...
								<td>
									<a
									href="<spring:url value="/employee/student/${std.id}" />"
...
<!--Add Studnet buttom  -->
				<div class="modal-footer">
					<a href="<spring:url value="/employee/addUser" />"
							class="btn btn-info" role="button">Add User</a>
				</div>	
