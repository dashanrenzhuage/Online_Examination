...
<link href="<c:url value = '/resources/css/report.css'></c:url>" rel="stylesheet">
...
<body class="nav-md">
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
			<form action="#" method="post">
				<div id="add_details" class="form-group">
				    <div class="row">
					    <div class="col-sm-1"></div>
						<div class="col-sm-9">
						    <label for="question">Add Student Details:</label>
						</div>
					...
					<div class="row">
					    <div class="col-sm-1"></div>
					    <div class="col-sm-9">
							Student Id: <input type="text" class="form-control" id="student_name" name="student_name" placeholder="Please enter student id" />
					    </div>
						<div class="col-sm-2"></div>
					</div>
				</div>
				<div id="Odiv2" class="form-group">
					<div class="row">
					    <div class="col-sm-1"></div>
						<div class="col-sm-9">
							Student Name:	<input type="text" class="form-control" id="stu_name" name="stu_name" placeholder="Please enter name" />
						</div>
						<div class="col-sm-2"></div>
					</div>
				</div>
				<div id="Odiv3" class="form-group">
					<div class="row">
					    <div class="col-sm-1"></div>
						<div class="col-sm-9">
							Email Address: <input type="text" class="form-control" id="email_address" name="email_address" placeholder="Please enter email address" />
						</div>
					</div>
				</div>
				<div id="Odiv3" class="form-group">
					...
					<div class="row">
					    <div class="col-sm-1"></div>
						<div class="col-sm-2">
							<button type="button" id="generate" class="btn add">Generate Access ID</button>
						</div>
						<div class="col-sm-7">
        ...
        <footer>
          <div class="pull-right">
              &copy; 2011 Maharishi University of Management. All rights reserved.
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
    ...
    <script src='<spring:url value="resources/js/add_student_detail.js"></spring:url>'></script>
  </body>
</html>